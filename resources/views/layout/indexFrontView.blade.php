      ...
      <div class="container-fluid mt-5">
        <div class="row px-5 py-5 mx-auto">
          <div class="col-md-4 col-sm-4 col-xs-12 segment-one text-center">
            ...
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Itaque repellat in dolore dicta a, quo
              ratione saepe quisquam est pariatur sunt repellendus iure sed repudiandae minima fugit. Error,
              sequi
              eius.</p>
            <div class="icon">
              <div class="row">
