 ...
 <div class="services-cover">
        <div class="container">
            <div class="jumbotron mt-2">
                <div class="col-12 text-center">
                    <img src="{{asset('storage/'.$serviceManagement->photo)}}" alt="" style="max-height:400px;">
                </div>
                <h2>{{$serviceManagement->title}}</h2>
                <p class="lead">{{$serviceManagement->shortdesc}}</p>
                <hr class="my-4">
                <h5>{{$serviceManagement->trainer}}</h5>
                <p>{{$serviceManagement->trainerdesc}}</p>
            </div>
        </div>
    </div>
    <!-- End Cover -->
    ...
    <div class="container">
        <div class="deskripsi ">
            <div class="row">
                <div class="col-6">
                    <?php echo $serviceManagement->content; ?>
                </div>
            </div>
        </div>
    </div>
