                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="row">
                            ...
                            @if((auth()->user()->photo) === '')
                                   ...
                                   <img src="{{ asset('css/img/photos.jpg') }}" alt="Profile Picture2" style="width:300px; border-radius:50%;" />
                            @else
                                   <img src="{{ asset('storage/'.auth()->user()->photo) }}" alt="Profile Picture1" style="width:300px; border-radius:50%;"/>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th class="text-left">
                                            <?php $id = auth()->user()->id; ?>
                                                <a href="{{url("/profile/$id/edit")}}" class="badge badge-success d-inline"> Edit Profile</a>
                                                <a href="{{url("/profile/$id/password")}}" class="badge badge-danger d-inline"> Edit Password</a>
